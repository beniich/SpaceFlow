#!/bin/bash
# ================================================================
# BeeCarbonat - Installation de la sync automatique dans la VM
# À exécuter UNE SEULE FOIS dans votre VM (terix@localhost)
# ================================================================

REPO_DIR="$HOME/BeeCarbonat"

echo "=== Installation Sync Automatique BeeCarbonat ==="
echo ""
...
echo "[3/3] Ajout du raccourci 'sync-BeeCarbonat'..."
echo "alias sync-BeeCarbonat='bash $REPO_DIR/scripts/vm-sync.sh'" >> ~/.bashrc
source ~/.bashrc

echo ""
echo "✅ Installation terminée !"
echo ""
echo "Pour synchroniser manuellement: sync-BeeCarbonat"
