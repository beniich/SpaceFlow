...
const portalCategories = [
  ...
  },
  {
    ...
    color: 'var(--brand-orange,_#f38020)',
    items: [
  ...
  const loadDashboard = useCallback(async (showLoader = true) => {
    ...
    try {
      ...
      if (response && response.data && !response.data.error) {
        ...
        const fromCache = response.headers?.['x-beecarbonat-offline'] === 'true' ||
                          response.headers?.['x-beecarbonat-from-cache'] === 'true' ||
                          !navigator.onLine;
    ...
    <div className="relative min-h-full bg-[#131313] overflow-hidden text-zinc-100 font-sans">
      ...
      <div className="relative z-10 p-6 lg:p-8 flex flex-col gap-6 max-w-[1600px] mx-auto w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          {/* System Status */}
          <div className="bg-zinc-900/50 backdrop-blur-md border border-zinc-800/60 rounded-xl p-6 flex flex-col justify-between relative overflow-hidden group shadow-lg hover:-translate-y-0.5 transition-all">
          ...
          {/* Energy Efficiency */}
          <div className="bg-zinc-900/50 backdrop-blur-md border border-zinc-800/60 rounded-xl p-6 flex flex-col justify-between relative overflow-hidden shadow-lg hover:-translate-y-0.5 transition-all">
            <div className="flex items-center justify-between mb-4">
              ...
              <svg className="w-full h-full" preserveAspectRatio="none" viewBox="0 0 100 30">
                <defs>
                  <linearGradient id="primaryGrad" x1="0" x2="0" y1="0" y2="1">
                    <stop offset="0%" stopColor="var(--brand-orange,_#f38020)" stopOpacity="0.25"></stop>
                    <stop offset="100%" stopColor="var(--brand-orange,_#f38020)" stopOpacity="0"></stop>
                  </linearGradient>
                </defs>
                ...
                <path d="M0,15 L10,20 L20,10 L30,22 L40,8 L50,18 L60,5 L70,15 L80,2 L90,12 L100,20" fill="none" stroke="var(--brand-orange,_#f38020)" strokeLinejoin="round" strokeWidth="1.5"></path>
              </svg>
            </div>
          </div>

          {/* Active Work Orders */}
          <div className="bg-gradient-to-br from-brand-orange to-[#f59e0b] rounded-xl p-6 text-black relative overflow-hidden shadow-[0_0_30px_rgba(243,128,32,0.15)] flex flex-col justify-between hover:shadow-[0_0_40px_rgba(243,128,32,0.3)] hover:-translate-y-0.5 transition-all">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 bg-zinc-900/40 backdrop-blur-md rounded-xl p-6 border border-zinc-800/60 shadow-md flex flex-col">
                ...
                <AreaChart data={charts?.woTrend || []} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                  <defs>
                    <linearGradient id="cyanGrad" x1="0" y1="0" x2="0" y2="1">
                      <stop offset="0%" stopColor="var(--brand-cyan,_#00dbe7)" stopOpacity={0.25} />
                      <stop offset="100%" stopColor="var(--brand-cyan,_#00dbe7)" stopOpacity={0} />
                    </linearGradient>
                    <linearGradient id="orangeGrad" x1="0" y1="0" x2="0" y2="1">
                      <stop offset="0%" stopColor="var(--brand-orange,_#f38020)" stopOpacity={0.15} />
                      <stop offset="100%" stopColor="var(--brand-orange,_#f38020)" stopOpacity={0} />
                    </linearGradient>
                  </defs>
                  ...
                  <Area
                    ...
                    fill="url(#cyanGrad)"
                    strokeWidth={2}
                    activeDot={{ r: 5, strokeWidth: 0, fill: 'var(--brand-cyan,_#00dbe7)' }}
                  />
                  <Area
                    type="monotone"
                    dataKey="created"
                    ...
                    fill="url(#orangeGrad)"
                    strokeWidth={1.5}
                    activeDot={{ r: 4, strokeWidth: 0, fill: 'var(--brand-orange,_#f38020)' }}
                  />
                </AreaChart>
              </ResponsiveContainer>
            </div>
          ...
          {/* Activity Log */}
          <div className="lg:col-span-1 bg-zinc-900/40 backdrop-blur-md rounded-xl p-6 border border-zinc-800/60 shadow-md flex flex-col">
              ...
              <AreaChart data={charts?.energyConsumption || []} margin={{ top: 10, right: -10, left: -25, bottom: 0 }}>
                <defs>
                  <linearGradient id="colorElec" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="5%" stopColor="var(--brand-cyan,_#00dbe7)" stopOpacity={0.15} />
                    <stop offset="95%" stopColor="var(--brand-cyan,_#00dbe7)" stopOpacity={0} />
                  </linearGradient>
                </defs>
                <CartesianGrid strokeDasharray="3 3" stroke="#222225" vertical={false} />
          ...
          <div className="bg-zinc-900/40 backdrop-blur-md rounded-xl p-6 border border-zinc-800/60 shadow-md">
            ...
            <ResponsiveContainer width="100%" height={260}>
              <BarChart data={charts?.maintenanceCostsByCategory || []} layout="vertical" margin={{ left: 10, top: 10 }}>
                ...
                <Bar dataKey="cost" fill="var(--brand-orange,_#f38020)" barSize={15} radius={[0, 4, 4, 0]} />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </div>
