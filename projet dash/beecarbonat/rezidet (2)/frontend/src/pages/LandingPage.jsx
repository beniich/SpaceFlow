          ...
          <nav className="hidden md:flex items-center gap-8 font-mono text-[11px] uppercase tracking-widest">
            {[
              ...
              >
                {tab.label}
                {activeTab === tab.id && (
                  <span className="absolute bottom-0 left-0 right-0 h-0.5 bg-brand-orange rounded-full shadow-[0_0_10px_rgba(243,128,32,0.6)]" />
                )}
              </button>
            ))}
            
            <a
              href="/dashboard_html/accueil_cafm_pro/code.html"
              target="_blank"
              rel="noopener noreferrer"
              className="text-brand-cyan hover:text-white transition-colors relative py-1.5 flex items-center gap-1"
            >
          ...
          <div className="space-y-24">
            ...
            <section className="relative w-full py-24 md:py-32 flex items-center justify-center overflow-hidden">
              ...
              <div className="relative z-10 max-w-7xl mx-auto px-6 w-full flex flex-col items-start gap-8">
                ...
                {/* Main Heading */}
                <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold max-w-4xl tracking-tighter leading-tight font-display text-zinc-100">
                  The Future of Infrastructure <span className="bg-clip-text text-transparent bg-gradient-to-r from-brand-cyan to-brand-orange drop-shadow-[0_0_20px_rgba(0,219,231,0.15)]">Management</span>
                </h1>

                {/* Subtext */}
                <p className="text-sm md:text-base text-zinc-400 max-w-2xl leading-relaxed font-sans">
                  The precision engineering standard for facility management. Empowering global infrastructure through hyper-accurate digital twins, automated telemetry, and real-time predictive analytics.
                </p>
                ...
                <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto mt-4">
                  ...
                  <button
                    ...
                    className="w-full sm:w-auto px-8 py-3.5 bg-zinc-900/60 hover:bg-zinc-800 text-zinc-200 hover:text-zinc-50 border border-zinc-800 font-mono text-[11px] uppercase tracking-widest text-center transition flex items-center justify-center gap-2"
                  >
                    ...
                    <svg className="w-full h-10 overflow-visible" viewBox="0 0 200 60">
                      ...
                      <defs>
                        <linearGradient id="sparkGrad" x1="0" x2="1" y1="0" y2="0">
                          <stop offset="0%" stopColor="var(--brand-cyan, #00dbe7)" />
                          <stop offset="60%" stopColor="var(--brand-cyan, #00dbe7)" />
                          <stop offset="100%" stopColor="var(--brand-orange, #f38020)" />
                        </linearGradient>
                      </defs>
                    </svg>
                  </div>
