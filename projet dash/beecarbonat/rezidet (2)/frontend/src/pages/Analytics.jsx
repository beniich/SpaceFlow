...
export default function Analytics() {
  ...
  const rechartsData = [
    { name: '00:00', vibration: 12, ref: 10 },
    { name: '02:00', vibration: 19, ref: 15 },
    { name: '04:00', vibration: 3, ref: 5 },
    { name: '06:00', vibration: 5, ref: 8 },
    { name: '08:00', vibration: 2, ref: 4 },
    { name: '10:00', vibration: 3, ref: 6 },
    { name: '12:00', vibration: 15, ref: 12 },
    { name: '14:00', vibration: 22, ref: 18 },
    { name: '16:00', vibration: 10, ref: 12 },
    { name: '18:00', vibration: 8, ref: 10 },
    { name: '20:00', vibration: 14, ref: 12 },
    { name: '22:00', vibration: 18, ref: 15 },
  ];
            ...
            <div className="bg-zinc-900/40 backdrop-blur-xl rounded-xl p-6 flex flex-col h-[500px] relative overflow-hidden group shadow-xl border border-zinc-800/40 hover:border-brand-cyan/30 transition-colors duration-500">
              <div className="flex justify-between items-start mb-6 relative z-10">
                ...
                <div className="flex items-center gap-2 bg-zinc-950/60 border border-zinc-800/60 py-1.5 px-3 rounded-full">
                  <span className="w-2 h-2 rounded-full bg-brand-cyan animate-pulse shadow-[0_0_8px_var(--brand-cyan, #00dbe7)]"></span>
                ...
                <svg className="w-full h-full text-brand-cyan overflow-visible" preserveAspectRatio="none" viewBox="0 0 800 300">
                  <defs>
                    <linearGradient id="heatGradient" x1="0%" x2="100%" y1="0%" y2="0%">
                      <stop offset="0%" stopColor="var(--brand-cyan, #00dbe7)" stopOpacity={0.1}></stop>
                      <stop offset="50%" stopColor="var(--brand-cyan, #00dbe7)" stopOpacity={0.8}></stop>
                      <stop offset="100%" stopColor="var(--brand-orange, #f38020)" stopOpacity={0.9}></stop>
                    </linearGradient>
                    <filter id="glow">
                  ...
                  <path d="M0,280 C150,260 250,180 350,200 C450,220 550,150 650,190 C750,230 780,210 800,200" fill="none" stroke="var(--brand-cyan, #00dbe7)" strokeDasharray="5 5" strokeOpacity="0.4" strokeWidth="2"></path>
                  
                  {/* Glowing scatter nodes */}
                  <g className="scatter-points" fill="var(--brand-orange, #f38020)">
                    <circle cx="300" cy="150" filter="url(#glow)" r="4">
                      <animate attributeName="r" dur="2s" repeatCount="indefinite" values="3;6;3"></animate>
                    </circle>
                    <circle cx="600" cy="80" fill="var(--brand-orange, #f38020)" filter="url(#glow)" r="5">
                      <animate attributeName="opacity" dur="1.5s" repeatCount="indefinite" values="1;0.5;1"></animate>
                    </circle>
                    <circle cx="200" cy="245" fill="var(--brand-cyan, #00dbe7)" r="3.5"></circle>
                    <circle cx="450" cy="65" fill="var(--brand-cyan, #00dbe7)" r="3"></circle>
                    <circle cx="700" cy="165" fill="var(--brand-cyan, #00dbe7)" r="4.5"></circle>
                  </g>
                </svg>
            ...
            <div className="bg-zinc-900/40 backdrop-blur-xl rounded-xl p-6 flex flex-col h-[350px] relative overflow-hidden group shadow-xl border border-zinc-800/40 hover:border-brand-orange/30 transition-colors duration-500">
              <div className="flex justify-between items-start mb-4 relative z-10">
                <div>
                  ...
                  <p className="font-mono text-[11px] text-zinc-400 mt-1">Real-time telemetry processed via Recharts.</p>
                </div>
                ...
                <ResponsiveContainer width="100%" height="100%">
                  <LineChart data={rechartsData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                    ...
                    <RechartsTooltip 
                      ...
                      labelStyle={{ fontFamily: 'monospace', fontSize: '11px', color: '#a1a1aa' }}
                    />
                    <RechartsLegend iconType="circle" wrapperStyle={{ fontSize: '11px', fontFamily: 'monospace' }} />
                    <RechartsLine type="monotone" dataKey="vibration" name="Vibration Spec (Hz)" stroke="var(--brand-orange, #f38020)" strokeWidth={2} dot={{ r: 3, fill: '#f38020', stroke: '#18181b' }} activeDot={{ r: 6 }} />
                    <RechartsLine type="monotone" dataKey="ref" name="Ref Signature (Hz)" stroke="var(--brand-cyan, #00dbe7)" strokeWidth={1.5} strokeDasharray="5 5" dot={{ r: 0 }} />
                  </LineChart>
                </ResponsiveContainer>
              </div>
            </div>
                ...
                <div>
                  ...
                  <div className="p-4 bg-zinc-950/60 border-l-2 border-brand-orange rounded-r">
                    ...
                    <div className="w-full bg-zinc-900 h-1.5 mt-3.5 rounded overflow-hidden">
                      <div className="bg-brand-orange h-full w-[87%] shadow-[0_0_10px_var(--brand-orange, #f38020)]"></div>
                    </div>
                  </div>
                </div>
